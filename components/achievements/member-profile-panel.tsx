 ...
 * behaalde badges.
 */
export function MemberProfileAchievements({ view }: { view: AchievementsView }) {
    ...
    <section className="flex flex-col gap-4 rounded-2xl border border-border bg-surface-1 p-5">
      <div className="flex items-center justify-between">
        <h2 className="flex items-center gap-2 text-sm font-semibold text-neutral-900">
          <Trophy className="size-4 text-accent" /> Trofeeën &amp; mijlpalen
        </h2>
      ...
      <div className="grid grid-cols-3 gap-3 text-sm">
        <div>
          <p className="text-neutral-500">Behaald</p>
        ...
        <div>
          <p className="text-neutral-500">Langste streak</p>
      ...
      {view.best ? (
        ...
        <p className="text-sm text-neutral-500">Dit lid heeft nog geen trofeeën behaald.</p>
      )}
